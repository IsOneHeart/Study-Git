...
label3.grid(row=2)
'''site = [('线路一', 'https://www.jsonplayer.com/'),
        ('线路二', 'https://www.1717yun.com/jx/ty.php'),
        ('线路三', 'https://jx.blbo.cc:4433/')]'''
# https://jx.618g.com/
site = [('线路一', 'https://jx.quanmingjiexi.com/'),
        ('线路二', 'https://www.wmxz.wang/video.php'),
        ('线路三', 'https://www.ckmov.vip/api.php'),
        ('线路四', 'https://www.jsonplayer.com/'),
        ('线路五', 'https://www.1717yun.com/jx/ty.php'),
        ('线路六', 'https://jx.blbo.cc:4433/')]
site_v = tk.StringVar()
